...
- ¿Por qué existen las empresas? Si los mercados asignan
  eficientemente los recursos, ¿para qué necesitamos las empresas?

- [[http://en.wikipedia.org/wiki/Ronald_Coase][Ronald Coase]]: las empresas coordinan el proceso de producción
...
- La *tecnología* permite que las empresas combinen *factores de
  producción* para obtener los *bienes de producción* que
...
- *Bienes de capitalq*: aquellos factores de producción que son ellos
  mismos bienes de producción: máquinas, herramientas, edificios y
  estructuras destinadas al proceso productivo.
...
- A largo plazo, la empresa puede elegir las cantidades que usa de
  todos los factores de producción: todos los factores de producción
...
- La función de producción relaciona el nivel de producción, $Q$, con
...
- A corto plazo el capital es fijo: $K = \overline{K}$.
...
- El $\PMgL$ es negativo siempre que $L > L_D$.
...
- La producción en $L_0$ es la misma que en $L_1$.
...
- La curva de $\PMeL$:
  ...
  + es creciente si $\PMgL > \PMeL$.

  + es decreciente si $\PMgL < \PMeL$.

  + llega a su máximo cuando $\PMgL = \PMeL$.
...
- La curva de producto total alcanza un máximo en $L_D$, donde $\PMgL = 0$.

- La curva de producto medio llega a su máximo en $L_E$, donde $\PMgL = \PMeL$.
