...
- La *tecnología* permite que las empresas combinen *factores de
  producción* para obtener los *bienes de producción* que venderán en
...
- *Bienes de capital*: aquellos factores de producción que son ellos
...
- La única forma en que la empresa puede aumentar su nivel de
  producción es usando más unidades del factor variable.
