...
** Tables
*** PIVE1
#+BEGIN_SRC latex :tangle unit01-tab-pive1.tex :noweb yes
...
*** PIVE2
#+BEGIN_SRC latex :tangle unit01-tab-pive2.tex :noweb yes
  \documentclass[figure]{mats}
  <<translations-pive>>
...
#+BEGIN_SRC latex :tangle unit01-fig-agents.tex :noweb yes
  \documentclass[figure]{mats}
  <<translations-circ>>
  \begin{document}
    <<circ-styles>>
...
#+BEGIN_SRC latex :tangle unit01-fig-markets.tex :noweb yes
  \documentclass[figure]{mats}
  <<translations-circ>>
  \begin{document}
    <<circ-styles>>
...
#+BEGIN_SRC latex :tangle unit01-fig-real.tex :noweb yes
  \documentclass[figure]{mats}
  <<translations-circ>>
  \begin{document}
    <<circ-styles>>
...
#+BEGIN_SRC latex :tangle unit01-fig-money.tex :noweb yes
  \documentclass[figure]{mats}
  <<translations-circ>>
  \begin{document}
    <<circ-styles>>
...
#+BEGIN_SRC latex :tangle unit01-fig-circ.tex :noweb yes
  \documentclass[figure]{mats}
  <<translations-circ>>
  \begin{document}
    <<circ-styles>>
