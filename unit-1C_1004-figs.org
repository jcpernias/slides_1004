...
#+BEGIN_SRC latex :tangle fig-1C_1004-dtab.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1C_1004-dtab2.tex :noweb no
  \footnotesize\sffamily%
  \begin{tikzpicture}
    \matrix  (john) [matrix of nodes,
    column sep=1mm, row sep = 1mm, anchor=south west,
...
#+BEGIN_SRC latex :tangle fig-1C_1004-dtab3.tex :noweb no
  \begin{tikzpicture}
...
*** Price changes
#+BEGIN_SRC latex :tangle fig-1C_1004-d2.tex :noweb no
  \begin{tikzpicture}
...
#+BEGIN_SRC latex :tangle fig-1C_1004-d3.tex :noweb no
  \begin{tikzpicture}
    \draw[IMe] (0, 3.5) -- (4.5, 0) node[pos=0.85, above right] { $Q^{d}(P)$ }
...
#+BEGIN_SRC latex :tangle fig-1C_1004-d4.tex :noweb no
  \begin{tikzpicture}
    \draw[IMe] (0, 3.5) -- (4.5, 0) node[pos=0.85, above right] { $Q^{d}(P)$ }
       node[pos=0.2] (A) {} node[pos=0.65] (B) {};
    \draw[help lines] let \p1 = (A), \p2 = (B) in
...
*** Demand shifts
#+BEGIN_SRC latex :tangle fig-1C_1004-d5.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1C_1004-d6.tex :noweb no
  \begin{tikzpicture}[xscale=0.1, yscale=0.1]
    \draw[IMe] (3, 45) .. controls (8, 18) and (20, 8) .. (45, 5)
       node[right] { $D$ }
       node[pos=0.5] (A) {} ;
...
#+BEGIN_SRC latex :tangle fig-1C_1004-d7.tex :noweb no
  \begin{tikzpicture}[xscale=0.1, yscale=0.1]
    \draw[IMe] (3, 45) .. controls (8, 18) and (20, 8) .. (45, 5)
       node[right] { $D$ }
       node[pos=0.5] (A) {} ;
...
#+BEGIN_SRC latex :tangle fig-1C_1004-d8.tex :noweb no
  \begin{tikzpicture}[xscale=0.1, yscale=0.1]
...
#+BEGIN_SRC latex :tangle fig-1C_1004-otab.tex :noweb no
  \footnotesize\sffamily%
  \begin{tikzpicture}
    \matrix  (john) [matrix of nodes,
    column sep=1mm, row sep = 1mm, anchor=south west,
...
#+BEGIN_SRC latex :tangle fig-1C_1004-otab3.tex :noweb no
  \begin{tikzpicture}
    \begin{scope}[xscale=0.4, yscale=0.8, font=\footnotesize]
       \draw[help lines, font=\scriptsize]
...
#+BEGIN_SRC latex :tangle fig-1C_1004-s2.tex :noweb no
  \begin{tikzpicture}
...
#+BEGIN_SRC latex :tangle fig-1C_1004-s3.tex :noweb no
  \begin{tikzpicture}
...
#+BEGIN_SRC latex :tangle fig-1C_1004-s4.tex :noweb no
  \begin{tikzpicture}
...
*** Equilibrium price
#+BEGIN_SRC latex :tangle fig-1C_1004-eq1.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1C_1004-eq2.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1C_1004-eq3.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1C_1004-eq4.tex :noweb no
...
*** Exchange points
#+BEGIN_SRC latex :tangle fig-1C_1004-eq5.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
*** A demand increase
#+BEGIN_SRC latex :tangle fig-1C_1004-comp1.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
*** A supply decrease
#+BEGIN_SRC latex :tangle fig-1C_1004-comp2.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1C_1004-comp3.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1C_1004-comp4.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1C_1004-tab_comp.tex :noweb no
  \footnotesize\sffamily%
  \begin{tikzpicture}
