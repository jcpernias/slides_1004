...
#+begin_src latex :tangle fig-2B_1004-ci02.tex :noweb no
...
#+begin_src latex :tangle fig-2B_1004-ci03.tex :noweb no
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-2B_1004-ci03b.tex :noweb no
  \begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-2B_1004-ci04.tex :noweb no
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-2B_1004-ci05.tex :noweb no
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-2B_1004-ci06.tex :noweb no
  \begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-2B_1004-tr01.tex :noweb no
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-2B_1004-map01.tex :noweb no
...
#+begin_src latex :tangle fig-2B_1004-rms01.tex :noweb no
\begin{tikzpicture}[xscale = 0.09, yscale = 0.09]
  \newcommand*{\const}{225}
  \newcommand*{\Ax}{8}
  \newcommand*{\Bx}{25}
...
#+begin_src latex :tangle fig-2B_1004-rms02.tex :noweb no
\begin{tikzpicture}[xscale = 0.09, yscale = 0.09]
  \newcommand*{\const}{225}
  \newcommand*{\Ax}{8}
  \newcommand*{\Bx}{25}
...
#+begin_src latex :tangle fig-2B_1004-rms03.tex :noweb no
\begin{tikzpicture}[xscale = 0.09, yscale = 0.09]
  \newcommand*{\const}{225}
  \newcommand*{\Ax}{8}
  \newcommand*{\Bx}{25}
...
#+begin_src latex :tangle fig-2B_1004-nreg01.tex :noweb no
\begin{tikzpicture}[xscale = 0.09, yscale = 0.09]
  \newcommand*{\Xcoord}{15}
  \newcommand*{\Ycoord}{10}
...
#+begin_src latex :tangle fig-2B_1004-nreg02.tex :noweb no
\begin{tikzpicture}[xscale = 0.09, yscale = 0.09]
  \newcommand*{\Xcoord}{4}
  \newcommand*{\Ycoord}{3}
  \newcommand*{\dX}{7.5}
...
#+begin_src latex :tangle fig-2B_1004-nreg03.tex :noweb no
\begin{tikzpicture}[xscale = 0.09, yscale = 0.09]
  \newcommand{\Xcoord}{10}
  \newcommand{\dX}{8}
...
#+begin_src latex :tangle fig-2B_1004-nreg04.tex :noweb no
\begin{tikzpicture}[xscale = 0.09, yscale = 0.09]
  \newcommand*{\Sx}{20}
  \newcommand*{\Sy}{5}
  \newcommand*{\Ex}{45}
...
#+begin_src latex :tangle fig-2B_1004-map02.tex :noweb no
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Uone}{120}
  \newcommand*{\Utwo}{300}
  \newcommand*{\Uthree}{520}
...
#+begin_src latex :tangle fig-2B_1004-map03.tex :noweb no
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Uone}{120}
  \newcommand*{\Utwo}{300}
  \newcommand*{\Uthree}{520}
