...
#+begin_src latex :tangle fig-t11-ci02.tex :noweb yes
...
#+begin_src latex :tangle fig-t11-ci03.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-t11-ci04.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-t11-ci05.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-t11-ci06.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-t11-tr01.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
...
#+begin_src latex :tangle fig-t11-map01.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Uone}{120}
  \newcommand*{\Utwo}{300}
...
#+begin_src latex :tangle fig-t11-rms01.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\const}{225}
  \newcommand*{\Ax}{8}
  \newcommand*{\Bx}{25}
...
#+begin_src latex :tangle fig-t11-rms02.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\const}{225}
  \newcommand*{\Ax}{8}
  \newcommand*{\Bx}{25}
...
#+begin_src latex :tangle fig-t11-rms03.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\const}{225}
  \newcommand*{\Ax}{8}
  \newcommand*{\Bx}{25}
...
#+begin_src latex :tangle fig-t11-nreg01.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Xcoord}{15}
  \newcommand*{\Ycoord}{10}
...
#+begin_src latex :tangle fig-t11-nreg02.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Xcoord}{4}
  \newcommand*{\Ycoord}{3}
  \newcommand*{\dX}{7.5}
...
#+begin_src latex :tangle fig-t11-nreg03.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand{\Xcoord}{10}
  \newcommand{\dX}{8}
...
#+begin_src latex :tangle fig-t11-nreg04.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Sx}{20}
  \newcommand*{\Sy}{5}
  \newcommand*{\Ex}{45}
...
#+begin_src latex :tangle fig-t11-fu01.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Uone}{120}
  \newcommand*{\Utwo}{300}
  \newcommand*{\Uthree}{520}
...
#+begin_src latex :tangle fig-t11-map02.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Uone}{120}
  \newcommand*{\Utwo}{300}
  \newcommand*{\Uthree}{520}
...
#+begin_src latex :tangle fig-t11-map03.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Uone}{120}
  \newcommand*{\Utwo}{300}
  \newcommand*{\Uthree}{520}
...
#+begin_src latex :tangle fig-t11-fu02.tex :noweb yes
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\Uone}{120}
  \newcommand*{\Utwo}{300}
  \newcommand*{\Uthree}{520}
