...
*** Relative variations
#+BEGIN_SRC latex :tangle fig-1D_1004-unicorn1.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1D_1004-unicorn2.tex :noweb no
  \begin{tikzpicture}[xscale=0.05, yscale=0.1]
    \coordinate (A) at (20, 30);
    \coordinate (B) at (40, 20);
...
#+BEGIN_SRC latex :tangle fig-1D_1004-unicorn3.tex :noweb no
  \begin{tikzpicture}[xscale=0.05, yscale=0.1]
    \coordinate (A) at (20, 30);
    \coordinate (B) at (40, 20);
...
#+BEGIN_SRC latex :tangle fig-1D_1004-unicorn4.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1D_1004-unicorn5.tex :noweb no
  \begin{tikzpicture}[xscale=0.05, yscale=0.1]
    \coordinate (A) at (20, 30);
    \coordinate (B) at (40, 20);
    \coordinate (C) at (60, 10);
...
#+BEGIN_SRC latex :tangle fig-1D_1004-elast8.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1D_1004-elast6.tex :noweb no
  \begin{tikzpicture}[xscale=0.1666667, yscale=0.83333]
...
#+BEGIN_SRC latex :tangle fig-1D_1004-elast7.tex :noweb no
  \begin{tikzpicture}[xscale=0.1666667, yscale=0.83333]
...
#+BEGIN_SRC latex :tangle fig-1D_1004-elast9.tex :noweb no
  \begin{tikzpicture}[xscale=0.1666667, yscale=0.83333]
...
#+BEGIN_SRC latex :tangle fig-1D_1004-ingr1.tex :noweb no
  \begin{tikzpicture}
...
#+BEGIN_SRC latex :tangle fig-1D_1004-ingr3.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1D_1004-ingr4.tex :noweb no
  \begin{tikzpicture}[xscale=0.16, yscale=0.75]
    \coordinate (A) at (9.375, 4);
    \coordinate (B) at (16.66667, 3);
...
#+BEGIN_SRC latex :tangle fig-1D_1004-ingr5.tex :noweb no
  \begin{tikzpicture}[xscale=0.16, yscale=0.75]
    \coordinate (A) at (9.375, 4);
    \coordinate (B) at (16.66667, 3);
...
#+BEGIN_SRC latex :tangle fig-1D_1004-ingr6.tex :noweb no
  \begin{tikzpicture}[xscale=0.16, yscale=0.75]
    \coordinate (A) at (15, 4);
    \coordinate (B) at (17.32051, 3);
...
#+BEGIN_SRC latex :tangle fig-1D_1004-unicorn6.tex :noweb no
  \begin{tikzpicture}[xscale=0.05, yscale=0.1]
    \coordinate (A) at (20, 30);
    \coordinate (B) at (40, 20);
...
#+BEGIN_SRC latex :tangle fig-1D_1004-unicorn7.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1D_1004-unicorn8.tex :noweb no
...
#+begin_src latex :tangle fig-1D_1004-unicorn10.tex :noweb no
\begin{tikzpicture}[xscale=0.05, yscale=0.1]
  \coordinate (A) at (20, 30);
  \coordinate (B) at (40, 20);
...
#+begin_src latex :tangle fig-1D_1004-unicorn11.tex :noweb no
\begin{tikzpicture}[xscale=0.05, yscale=0.1]
  \coordinate (A) at (20, 30);
  \coordinate (B) at (40, 20);
...
#+BEGIN_SRC latex :tangle fig-1D_1004-elast10.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1D_1004-elast11.tex :noweb no
  \begin{tikzpicture}[xscale=0.135, yscale=0.675]
...
#+BEGIN_SRC latex :tangle fig-1D_1004-elast12.tex :noweb no
  \begin{tikzpicture}[xscale=0.135, yscale=0.675]
    \coordinate (A) at (15, 3) ;
...
#+BEGIN_SRC latex :tangle fig-1D_1004-elast13.tex :noweb no
  \begin{tikzpicture}[xscale=0.135, yscale=0.675]
    \coordinate (A) at (15, 3) ;
    \coordinate (B) at (25, 4) ;
