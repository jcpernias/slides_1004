...
** Example:\NL interior solution\NL (I)
- Utility function: $U(X, Y) = X Y$.
- Prices: $P_X = 2$ € per unit; $P_Y = 2$ € per unit.
- Monetary rent: $M = 70$ €.


** Example:\NL interior solution\NL (and II)
...
** Example:\NL corner solution\NL (I)
- Utility function: $U(X, Y) = (X + 50) Y$.
- Prices: $P_X = 2$ € per unit; $P_Y = 2$ € per unit.
- Monetary rent: $M = 70$ €.


** Example:\NL corner solution\NL (and II)
