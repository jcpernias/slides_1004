...
#+begin_src latex :tangle fig-2A_1004-xy.tex :noweb no
...
#+begin_src latex :tangle fig-2A_1004-rp1.tex
...
#+begin_src latex :tangle fig-2A_1004-rp3.tex
  \begin{tikzpicture}[<<scale>>]
    <<macros>>
...
#+begin_src latex :tangle fig-2A_1004-rp4.tex
  \begin{tikzpicture}[<<scale>>]
    <<macros>>
...
#+begin_src latex :tangle fig-2A_1004-rp5.tex
  \begin{tikzpicture}[<<scale>>]
    <<macros>>
...
#+begin_src latex :tangle fig-2A_1004-rp6.tex
\begin{tikzpicture}[<<scale>>]
<<macros>>
...
#+begin_src latex :tangle fig-2A_1004-rp7.tex
\begin{tikzpicture}[<<scale>>]
<<macros>>
...
#+begin_src latex :tangle fig-2A_1004-rp8.tex
\begin{tikzpicture}[<<scale>>]
<<macros>>
...
#+begin_src latex :tangle fig-2A_1004-rp10.tex
\begin{tikzpicture}[<<scale>>]
<<macros>>
...
#+begin_src latex :tangle fig-2A_1004-rp11.tex
\begin{tikzpicture}[<<scale>>]
<<macros>>
...
#+begin_src latex :tangle fig-2A_1004-rac1.tex
\begin{tikzpicture}[<<scale>>]
...
#+begin_src latex :tangle fig-2A_1004-orp2.tex
\begin{tikzpicture}[<<scale>>]
<<macros>>
...
#+begin_src latex :tangle fig-2A_1004-orp3.tex
\begin{tikzpicture}[<<scale>>]
<<macros>>
...
#+begin_src latex :tangle fig-2A_1004-orp4.tex
  \begin{tikzpicture}[<<scale>>]
    <<macros>>
