...
** Markets
- A market is the set of buyers and sellers of a particular good or service.
...
- *Prices of other goods*:
  ...
  + *Substitute goods*: consumption alternatives. Demand increases if the
    price of a substitute good increases.
    

** Other determinants of demand (and III)
- *Market size*: the higher is the amount of consumers, the higher is the
  demand.
...
** Equilibrium
- At the *equilibrium price* the quantity demanded coincides with the quantity supplied.
...
- The intersection between supply and demand determines the equilibrium price and quantity.
  \[ D(P^*) = S(P^*) \]
...
-  When the price exceeds the equilibrium price, sellers do not sell all the production.


** Shortage
#+figure: ./figures/fig-t03-eq4.pdf 0.45

- When the price is below the equilibrium price, production is lower than the quantity consumers are willing to buy.
