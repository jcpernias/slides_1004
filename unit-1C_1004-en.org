...
- They show the quantity a consumer demands at each possible price.
...
- The market price has fallen to $P_B$, but no other determinant of
  demand has changed.
...
- The *income* of consumers:
  ...
  + *Normal good*: the quantity demanded increases when income
    increases.

  + *Inferior good*: the quantity demanded decreases when income
    increases.
...
- *Prices of other goods*:
  ...
  + *Complementary goods*: goods that are usually consumed together: the
    quantity demanded increases if the price of a complementary good
    falls.

  + *Substitute goods*: one good is used in place of the other: the
    quantity demanded increases if the price of a substitute good
    increases.
...
- When the price exceeds the equilibrium price, suppliers dare unable
