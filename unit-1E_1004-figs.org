...
#+BEGIN_SRC latex :tangle fig-1E_1004-pmax1.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1E_1004-pmax2.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1E_1004-pmax3.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1E_1004-pmin1.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1E_1004-pmin2.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1E_1004-pmin3.tex :noweb no
  \begin{tikzpicture}[xscale=0.5, yscale=0.5]
...
#+BEGIN_SRC latex :tangle fig-1E_1004-st1.tex :noweb no
  \begin{tikzpicture}
...
#+BEGIN_SRC latex :tangle fig-1E_1004-st2.tex :noweb no
  \begin{tikzpicture}
...
#+BEGIN_SRC latex :tangle fig-1E_1004-st3.tex :noweb no
  \begin{tikzpicture}
    \coordinate (E0) at (2, 2) ;
    \coordinate (E1) at (1, 3) ;
    \coordinate (T) at (1, 1) ;
...
#+BEGIN_SRC latex :tangle fig-1E_1004-st4.tex :noweb no
  \begin{tikzpicture}
    \coordinate (E0) at (2, 2) ;
    \coordinate (E1) at (1, 3) ;
    \coordinate (T) at (1, 1) ;
...
#+BEGIN_SRC latex :tangle fig-1E_1004-bt1.tex :noweb no
  \begin{tikzpicture}
...
#+BEGIN_SRC latex :tangle fig-1E_1004-bt2.tex :noweb no
  \begin{tikzpicture}
    \coordinate (E0) at (2, 2) ;
...
#+BEGIN_SRC latex :tangle fig-1E_1004-bt3.tex :noweb no
  \begin{tikzpicture}
    \coordinate (E0) at (2, 2) ;
    \coordinate (E1) at (1, 1) ;
    \coordinate (T) at (1, 3) ;
...
#+BEGIN_SRC latex :tangle fig-1E_1004-bt4.tex :noweb no
  \begin{tikzpicture}
    \coordinate (E0) at (2, 2) ;
    \coordinate (E1) at (1, 1) ;
    \coordinate (T) at (1, 3) ;
...
#+BEGIN_SRC latex :tangle fig-1E_1004-inc1.tex :noweb no
  \begin{tikzpicture}
    \coordinate (E0) at (2, 2) ;
    \coordinate (E1) at (1, 1) ;
     \coordinate (T) at (1, 3) ;
...
#+BEGIN_SRC latex :tangle fig-1E_1004-inc2.tex :noweb no
  \begin{tikzpicture}
...
#+BEGIN_SRC latex :tangle fig-1E_1004-inc3.tex :noweb no
  \begin{tikzpicture}
