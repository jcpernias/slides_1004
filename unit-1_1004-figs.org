...
*** Production tables
#+BEGIN_SRC latex :tangle fig-1_1004-tab_fpp1.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1_1004-prod.tex :noweb no
...
#+BEGIN_SRC latex :tangle fig-1_1004-prod2.tex :noweb no
  \begin{tikzpicture}[xscale = 0.3, yscale = 0.3]
...
*** Production options
#+BEGIN_SRC latex :tangle fig-1_1004-tab_fpp2.tex :noweb no
  \footnotesize\sffamily%
  \begin{tikzpicture}
...
*** PPF
#+BEGIN_SRC latex :tangle fig-1_1004-fpp1.tex
...
#+BEGIN_SRC latex :tangle fig-1_1004-fpp2a.tex
  \begin{tikzpicture}<<scale-ppf>>
...
#+BEGIN_SRC latex :tangle fig-1_1004-fpp1a.tex
  \begin{tikzpicture}<<scale-ppf>>
...
#+BEGIN_SRC latex :tangle fig-1_1004-fpp2.tex
  \begin{tikzpicture}<<scale-ppf>>
...
#+BEGIN_SRC latex :tangle fig-1_1004-fpp3a.tex
  \begin{tikzpicture}<<scale-ppf>>
...
#+BEGIN_SRC latex :tangle fig-1_1004-fpp3.tex
  \begin{tikzpicture}<<scale-ppf>>
    \newcommand*{\Ax}{2.8}
    \newcommand*{\Cx}{5}
    \newcommand*{\Ay}{6}
...
#+BEGIN_SRC latex :tangle fig-1_1004-fpp4.tex
...
#+BEGIN_SRC latex :tangle fig-1_1004-fpp5.tex
...
#+BEGIN_SRC latex :tangle fig-1_1004-tab_fpp3.tex
...
*** Slope
#+BEGIN_SRC latex :tangle fig-1_1004-fpp6.tex
...
*** Concavity
#+BEGIN_SRC latex :tangle fig-1_1004-fpp7.tex
...
*** Growth
#+BEGIN_SRC latex :tangle fig-1_1004-gr2.tex
  \begin{tikzpicture}<<scale-ppf>>
...
#+BEGIN_SRC latex :tangle fig-1_1004-gr3.tex
  \begin{tikzpicture}<<scale-ppf>>
...
#+BEGIN_SRC latex :tangle fig-1_1004-gr1.tex
  \begin{tikzpicture}<<scale-ppf>>
