...
#+begin_src latex :tangle fig-6B_1004-eq01.tex :noweb no
...
#+begin_src latex :tangle fig-6B_1004-eq02.tex :noweb no
  \begin{tikzpicture}[xscale=0.2, yscale=0.2]
    \draw[IMe]
...
#+begin_src latex :tangle fig-6B_1004-eq03.tex :noweb no
  \begin{tikzpicture}[xscale=0.2, yscale=0.2]
...
#+begin_src latex :tangle fig-6B_1004-eq04.tex :noweb no
  \begin{tikzpicture}[xscale=0.2, yscale=0.2]
...
#+begin_src latex :tangle fig-6B_1004-eq06.tex :noweb no
  \begin{tikzpicture}[xscale=0.2, yscale=0.2]
...
#+begin_src latex :tangle fig-6B_1004-eq07.tex :noweb no
  \begin{tikzpicture}[xscale=0.2, yscale=0.2]
...
#+begin_src latex :tangle fig-6B_1004-eq05.tex :noweb no
  \begin{tikzpicture}[xscale=0.2, yscale=0.2]
...
#+begin_src latex :tangle fig-6B_1004-eq08.tex :noweb no
  \begin{tikzpicture}[xscale=0.2, yscale=0.2]
...
#+begin_src latex :tangle fig-6B_1004-exp02.tex :noweb no
...
#+begin_src latex :tangle fig-6B_1004-clp01.tex :noweb no
...
#+begin_src latex :tangle fig-6B_1004-clp02.tex :noweb no
...
#+begin_src latex :tangle fig-6B_1004-clp03.tex :noweb no
\begin{tikzpicture}[yscale=0.9, xscale=0.9]
...
#+begin_src latex :tangle fig-6B_1004-exp03.tex :noweb no
...
#+begin_src latex :tangle fig-6B_1004-exp06.tex :noweb no
  \begin{tikzpicture}[xscale=0.2777777778, yscale=0.3125]
...
#+begin_src latex :tangle fig-6B_1004-exp07.tex :noweb no
\begin{tikzpicture}[xscale=0.2777777778, yscale=0.3125]
...
#+begin_src latex :tangle fig-6B_1004-exp04.tex :noweb no
\begin{tikzpicture}[xscale=0.2777777778, yscale=0.3125]
...
#+begin_src latex :tangle fig-6B_1004-exp05.tex :noweb no
\begin{tikzpicture}[xscale=0.2777777778, yscale=0.3125]
