...
- The inverse of the total product function shows the amount of labor
  required to obtain a given level of output:
  #+begin_export latex
  \[ L = f^{-1}(Q) \]
  #+end_export
...
- *Marginal cost*: the rate at which total cost varies per
...
- The average variable cost:
  ...
  + decreases when $\CMg < \CVMe$.

  + increases when $\CMg > \CVMe$.
...
#+MATS: figcol fig-6A_1004-sr09-*.pdf 0.55
...
- The average cost:
  ...
  + decreases when $\CMg < \CMe$.

  + increases when $\CMg > \CMe$.
