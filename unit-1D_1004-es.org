...
- Cuando sube el precio: \textcolor{DarkRed}{¡¡¡} $E_d =-1$
  \textcolor{DarkRed}{!!!}
...
- Los ingresos totales de los vendedores del bien:
  #+begin_export latex
  \[ I_1 = P_1 \cdot Q_1 \]
  #+end_export
...
- Flexibilidad de adaptación de la producción a cambios en el
  precio.
