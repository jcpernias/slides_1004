...
- *Capital goods*: those factors of production which are themselves produced
  goods: machinery, tools, buildings and structures used for the
  production process.
...
- In the long-run firm can choose the quantities of all inputs: all
