...
#+begin_src latex :tangle fig-2C_1004-oc01.tex :noweb yes
...
#+begin_src latex :tangle fig-2C_1004-oc02.tex :noweb yes
  \begin{tikzpicture}[<<oc-scale>>]
    <<oc-budget>>
...
#+begin_src latex :tangle fig-2C_1004-oc03.tex :noweb yes
  \begin{tikzpicture}[<<oc-scale>>]
    <<oc-budget>>
...
#+begin_src latex :tangle fig-2C_1004-eq01.tex :noweb yes
...
#+begin_src latex :tangle fig-2C_1004-eq01a.tex :noweb yes
  \begin{tikzpicture}[<<is-scale>>]
    <<is-curves>>
    <<is-Adot>>
    <<is-Amarks>>
...
#+begin_src latex :tangle fig-2C_1004-eq02.tex :noweb yes
  \begin{tikzpicture}[<<is-scale>>]
    <<is-curves>>
    <<is-Bdot>>
    <<is-axes>>
...
#+begin_src latex :tangle fig-2C_1004-eq02a.tex :noweb yes
  \begin{tikzpicture}[<<is-scale>>]
    <<is-curves>>
    <<is-Bdot>>
    <<is-Bmarks>>
...
#+begin_src latex :tangle fig-2C_1004-eq03.tex :noweb yes
  \begin{tikzpicture}[<<is-scale>>]
    <<is-curves>>
    <<is-Edot>>
    <<is-Amarks>>
...
#+begin_src latex :tangle fig-2C_1004-ej01.tex :noweb yes
...
#+begin_src latex :tangle fig-2C_1004-eq10.tex :noweb yes
...
#+begin_src latex :tangle fig-2C_1004-eq11.tex :noweb yes
  \begin{tikzpicture}[<<cs-scale>>]
...
#+begin_src latex :tangle fig-2C_1004-ej02.tex :noweb yes
  \begin{tikzpicture}[xscale = 0.085, yscale = 0.085]
    \newcommand*{\Utwo}{1750}
