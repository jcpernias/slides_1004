...
** The minimization\NL of the production cost
...
** Average cost and\NL marginal cost\NL(I)
...
** Economies and diseconomies of scale\NL (I)
...
** Returns to scale and costs in the long-run\NL(II)
...
** Returns to scale and costs in the long-run\NL(III)
...
** Returns to scale and costs in the long-run\NL(and IV)
...
** The short-run and\NL the long-run choice
...
** Short-run\NL and long-run costs\NL (and III)
...
** The choice of the\NL plant size\NL (I)
...
** The choice of the\NL plant size\NL (and II)
