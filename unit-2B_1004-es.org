...
** Mapa de curvas\NL de indiferencia
...
** Relación Marginal\NL de Sustitución\NL (I)
...
** Relación Marginal\NL de Sustitución\NL (II)
...
** Relación Marginal\NL de Sustitución\NL (y III)
...
** Otros casos\NL de preferencias\NL (I)
...
** Otros casos\NL de preferencias\NL (II)
...
** Otros casos\NL de preferencias\NL (III)
...
** Otros casos\NL de preferencias\NL (y IV)
...
** Utilidad marginal y\NL la RMS\NL (I)
...
** Utilidad marginal y\NL la RMS\NL (II)
...
** Utilidad marginal y\NL la RMS\NL (III)
...
** Utilidad marginal y\NL la RMS\NL (y IV)
