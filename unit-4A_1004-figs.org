...
#+begin_src latex :tangle fig-4A_1004-map01.tex :noweb no
...
#+begin_src latex :tangle fig-4A_1004-rms01.tex :noweb no
\begin{tikzpicture}[xscale = 0.1, yscale = 0.1]
  \newcommand*{\const}{225}
  \newcommand*{\Ax}{8}
  \newcommand*{\Bx}{25}
...
#+begin_src latex :tangle fig-4A_1004-cisv01.tex :noweb no
